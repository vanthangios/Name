...
local Tabs = {
    ...
    Callback = function()
        setclipboard("https://discord.gg/S34FfYCZcommunity-1253927333920899153")
    end
})
    ...
    Callback = function()
        setclipboard(https://youtube.com/@vanthangdayyy?si=lYkXk1-Cw5TYd3or
    end
})
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/vanthangios/Ch-/refs/heads/main/V%C4%83n%20Th%E1%BA%AFng%20IOS%20v3.txt"))()
})
